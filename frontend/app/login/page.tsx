      ...
      <div className="max-w-4xl w-full bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-gray-100">
        ...
        <div className="md:w-1/2 bg-primary-500 text-white p-12 flex flex-col justify-center relative overflow-hidden">
          <div className="relative z-10 space-y-6">
            <h2 className="text-4xl font-bold leading-tight">Safe and Reliable Digital Pharmacy</h2>
            <p className="text-primary-100 text-lg leading-relaxed">
              Access your prescriptions and health essentials with the security and precision you deserve.
            </p>
          </div>
        ...
        <div className="md:w-1/2 p-10 md:p-14 flex flex-col relative">
          <div className="mb-10">
            ...
            <p className="text-gray-500">Log in to manage your medications securely.</p>
          </div>
          ...
          <form className="space-y-6 flex-grow">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <Link href="#" className="text-sm font-medium text-primary-500 hover:text-primary-400">Forgot password?</Link>
            </div>

            <button type="button" className="w-full bg-primary-500 hover:bg-primary-400 text-white font-medium py-3.5 rounded-xl transition-colors shadow-md mt-4">
              Login
            </button>
          </form>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 text-center text-sm text-gray-600">
              New to Apomacy? <Link href="/register" className="font-semibold text-primary-500 hover:text-primary-400">Register</Link>
            </div>
          </div>
          ...
          <div className="absolute bottom-6 left-0 right-0 flex justify-center items-center gap-6 text-[10px] font-semibold text-gray-400 tracking-wider">
            <div className="flex items-center gap-1.5"><ShieldCheck size={14} /> HIPAA SECURE</div>
