                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-apomacy-ice transition hover:text-white"
                                >
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="text-apomacy-ice">
                                            support@apomacy.id
                                        </span>
                                    </a>
                                </li>
                ...
                <div className="mt-12 border-t border-white/20 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-apomacy-ice">
                            ...
                            <Link
                                className="ml-1 inline-block text-white underline transition hover:text-apomacy-ice"
                                href="#"
                            >
                                Syarat &amp; Ketentuan
                            </Link>
                            ...
                            <Link
                                className="inline-block text-white underline transition hover:text-apomacy-ice"
                                href="#"
                            >
                                Kebijakan Privasi
                            </Link>
